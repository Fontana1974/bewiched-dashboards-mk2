...
def build(coach):
    ...
    mix_note=f"Hot drinks anchor the mix; <b>Food capture sits at ~{foodcap}%</b> across the area — the clearest add-on prize."
    ...
    repl={
     ...
     "{{AREA_WASTE_PCT}}":str(awpct),"{{AREA_WASTE_RETAIL}}":GBP(awr),"{{CON_POS}}":con_pos,"{{CON_META}}":con_meta,
